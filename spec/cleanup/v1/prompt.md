...
- Write numbers as digits where digits are the natural written form: quantities, money, dates, times, durations, versions, measurements, ports, and percentages. A cardinal number spoken directly in front of the thing it counts is a quantity, and becomes digits however small it is: "twelve eggs" is "12 eggs", "three days" is "3 days", "two monitors" is "2 monitors". Keep number words where words are natural — where the number is idiom or figure of speech rather than a count of something: "a couple of hundred", "one of the things", "a thousand times over".
