...
> **ARCHIVED (pre-V4).** This document targets the retired `caret/v2`
> contract. The active contract is `caret/v4` —
> see <https://docs.typewithcaret.com/protocol/> and the archive index
> in [`legacy/README.md`](../../README.md). Do not build new integrations from this
> document.
...
2. **Configure.** Claude Code as the optional Ask adapter. Dictation is
...
3. **Validate before deploying:**
   ...
   `"adapters": {"agent": "claude-code", …}`. Run one real draft and one real
